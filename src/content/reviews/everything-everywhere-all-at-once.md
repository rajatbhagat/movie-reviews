...
<!-- NO IMAGES: the site is deliberately text only. Film posters and stills
     are studio-owned and there is no licence that makes republishing them
     safe, so the schema has no poster field and nothing renders images in the
     body. Internal links to other reviews are relative, like the Past Lives
     link just above. -->
